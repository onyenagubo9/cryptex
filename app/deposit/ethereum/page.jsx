...
export default function EthereumDeposit() {
  ...
  const [address] = useState("0x5d57753a0888addef136e7de1ec27fcef056170e"); // Replace with real BTC address
  const [network] = useState("Ethereum Network (ETH)");
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center p-6 sm:p-12">
      <h1 className="text-3xl font-bold mb-8 text-yellow-400">Deposit Ethereum Ξ</h1>
      ...
      <div className="bg-gray-800/50 border border-gray-700 rounded-2xl w-64 h-64 flex items-center justify-center mb-6 shadow-lg overflow-hidden">
        <img 
          src="/eth-code.jpeg" // Place your QR code image inside /public folder
          alt="Etheruem QR Code" 
