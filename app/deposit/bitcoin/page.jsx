...
export default function BitcoinDeposit() {
  ...
  const [address] = useState("1GN7t6MQDWUNx24xdnVfkfkmRJ7QkWDGZc"); // Replace with real BTC address
  const [network] = useState("Bitcoin Network (BTC)");
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center p-6 sm:p-12">
      <h1 className="text-3xl font-bold mb-8 text-yellow-400">Deposit Bitcoin ₿</h1>
      ...
      <div className="bg-gray-800/50 border border-gray-700 rounded-2xl w-64 h-64 flex items-center justify-center mb-6 shadow-lg overflow-hidden">
        <img 
          src="/btc-code.jpeg" // Place your QR code image inside /public folder
          alt="Bitcoin QR Code" 
